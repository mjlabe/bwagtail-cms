# Generated by Django 2.1.4 on 2018-12-23 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='auth.Group')),
        ...
        migrations.AddField(
            model_name='footer',
            name='site_settings',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='footer', to='utils.SiteSettings'),
        ),
    ]
